...
class fonts2vec:
    def __init__(
        ...
        xml_main,
        excel_file,
        npy_files=["classes_font_width.npy", "classes_font_type.npy"],
    ):
    ...
    def vectorize_fontwidth_fonttype(self, df):
        ...
        encoder1.classes_ = np.load(self.npy_files[0], allow_pickle=True)
        encoder2 = LabelEncoder()
        encoder2.classes_ = np.load(self.npy_files[1], allow_pickle=True)
